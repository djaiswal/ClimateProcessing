...
filename<-paste(maindirectory,modelname,"/tas_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
tavg<-ncvar_get(tmp0)
nc_close(tmp0)

#Reading maximum temperature
filename<-paste(maindirectory,modelname,"/tasmax_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
tmax<-ncvar_get(tmp0)
nc_close(tmp0)

#Reading minimum temperature
filename<-paste(maindirectory,modelname,"/tasmin_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
tmin<-ncvar_get(tmp0)
nc_close(tmp0)

#Reading precipitation
filename<-paste(maindirectory,modelname,"/pr_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
pr<-ncvar_get(tmp0)
nc_close(tmp0)

#Reading  wind
filename<-paste(maindirectory,modelname,"/wind_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
wind<-ncvar_get(tmp0)
nc_close(tmp0)
...
#Shortwave radiation
filename<-paste(maindirectory,modelname,"/rsds_bced_1960_1999_hadgem2-es_",scenarioname,"_",yearinterval[3],".nc", sep="")
tmp0<-nc_open(filename)
sRad<-ncvar_get(tmp0)
nc_close(tmp0)
